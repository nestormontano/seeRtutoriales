...
```{r ini_s1, echo=FALSE, fig.align='center',  out.width = "400px"}
...
```{r ini_s2, fig.align='center', echo=FALSE,  out.width = "400px"}
   knitr::include_graphics('images/PosterProgDataScienceFB.jpg')
```
...
*Debe tener instalada el paquete openxlsx para esta parte del tutorial*
...
## Transform: Aplicar funciones a columnas
